-- Complete database setup for Smart Tourism Guide Application
...
-- Insert sample monuments with 3D model URLs
INSERT INTO public.monuments (name, description, historical_info, location, category, model_url) VALUES
('Taj Mahal', 'An ivory-white marble mausoleum on the right bank of the river Yamuna', 'Built by Mughal Emperor Shah Jahan in memory of his wife Mumtaz Mahal. Construction began in 1632 and was completed in 1653.', 'Agra, Uttar Pradesh', 'Monument', null),
('Charminar', 'A monument and mosque located in Hyderabad', 'Built in 1591 by Muhammad Quli Qutb Shah to commemorate the founding of Hyderabad and the end of a deadly plague.', 'Hyderabad, Telangana', 'Monument', 'https://sketchfab.com/models/bb880d064036496ca14ebac08a243af0/embed?autostart=1&internal=1&tracking=0&ui_infos=0&ui_snapshots=1&ui_stop=0&ui_watermark=0'),
('Golconda Fort', 'A historic fort and ruined city', 'Originally known as Mankal, Golconda Fort was built by the Kakatiyas and later enhanced by the Qutb Shahi dynasty in the 16th century.', 'Hyderabad, Telangana', 'Fort', null),
('Red Fort', 'A historic fort in the city of Delhi', 'Constructed in 1639 by the fifth Mughal Emperor Shah Jahan as the palace of his fortified capital Shahjahanabad.', 'Delhi', 'Fort', null),
('Qutub Minar', 'A minaret and victory tower that forms part of the Qutb complex', 'Built in the early 13th century by Qutb ud-Din Aibak, the first ruler of the Delhi Sultanate.', 'Delhi', 'Monument', null)
